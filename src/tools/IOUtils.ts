import { decodeStack, Image as IJSImage, Stack as IJSStack } from "image-js";
import { TiffReader } from "./TiffReader";

import { ImageShapeEnum } from "./types";
import type {
  ChannelResult,
  ImageResult,
  ImageSeriesResult,
...
import { DEFAULT_COLORS, devError } from "@/utils";
...
const extractImageDimensionsFromStack = (
  imageStack: IJSStack,
